...
export function App() {
  ...
  async function resolveRecovery(run, policy) {
    try {
      await api(`/api/runs/${run.id}/resume`, { method: "POST", body: { policy } });
